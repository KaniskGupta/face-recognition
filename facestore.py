<!DOCTYPE html>
<!-- saved from url=(0098)https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link crossorigin="anonymous" media="all" integrity="sha512-qQ+v+W1uJYfDMrQ/cwCVI+AGTsn1yi4rCU6KX45obe52BoF+WiHNeQ11u63iJA05vyivY57xNbhAsyK4/j1ZIQ==" rel="stylesheet" href="./facestore_files/frameworks-01356238c65ce56a395237b592b58668.css">
  <link crossorigin="anonymous" media="all" integrity="sha512-t0NF/zTUOsfEylXqNma8KFz+xQCKaQoQNHHVCMWmDddHyQElu8fMjlagXnjvLlZZRR0WO+8FzRfNrNiTXBqjug==" rel="stylesheet" href="./facestore_files/github-a7e9a45d2e105efd3c1662a142599b6e.css">
  ...
  <title>ML_JulyRegularEvening/faceStore.py at master · ravi4all/ML_JulyRegularEvening</title>
...
<link rel="manifest" href="https://github.com/manifest.json" crossorigin="use-credentials">
  ...
  <meta name="selected-link" value="repo_source" data-pjax-transient=""><meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient=""><meta name="request-id" content="C55D:5F56:480BCB:80FF8D:5B6977A2" data-pjax-transient=""><link rel="canonical" href="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py" data-pjax-transient=""><link href="https://github.com/ravi4all/ML_JulyRegularEvening/commits/master.atom" rel="alternate" title="Recent Commits to ML_JulyRegularEvening:master" type="application/atom+xml" data-pjax-transient=""></head>

  <body class="logged-in env-production intent-mouse">
    

  <div class="position-relative js-header-wrapper ">
    <a href="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py#start-of-content" tabindex="1" class="p-3 bg-blue text-white show-on-focus js-skip-to-content">Skip to content</a>
      ...
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text" class="form-control header-search-input jump-to-field js-jump-to-field js-site-search-focus js-site-search-field is-clearable" data-hotkey="s,/" name="q" value="" placeholder="Search or jump to…" data-unscoped-placeholder="Search or jump to…" data-scoped-placeholder="Search or jump to…" autocapitalize="off" aria-autocomplete="list" aria-controls="jump-to-results" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=M+B5Y72sz4bxpTLTV5wmHVlcryC8FExoy9D6h+noc7li08BZDOJB8aab2E5ZEvCbEnYUAyMuqLTsjaALVvo8tA==" spellcheck="false" autocomplete="off">
          <input type="hidden" class="js-site-search-type-field" name="type">
            <img src="./facestore_files/search-shortcut-hint.svg" alt="" class="mr-2 header-search-key-slash">

            <div class="Box position-absolute overflow-hidden d-none jump-to-suggestions js-jump-to-suggestions-container">
              <ul class="d-none js-jump-to-suggestions-template-container">
                <li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item">
                  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center p-2 jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open" href="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py">
                    <div class="jump-to-octicon js-jump-to-octicon mr-2 text-center d-none"></div>
                    <img class="avatar mr-2 flex-shrink-0 js-jump-to-suggestion-avatar" alt="" aria-label="Team" src="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py" width="28" height="28">
              ...
              <ul id="jump-to-results" class="js-navigation-container jump-to-suggestions-results-container js-jump-to-suggestions-results-container">
                <li class="d-flex flex-justify-center flex-items-center p-0 f5">
                  <img src="./facestore_files/octocat-spinner-128.gif" alt="Octocat Spinner Icon" class="m-2" width="28">
                </li>
              </ul>
            </div>
      </label>
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1" aria-label="View profile and more" data-ga-click="Header, show menu, icon:avatar" aria-haspopup="menu">
        <img alt="@KaniskGupta" class="avatar float-left mr-1" src="./facestore_files/42166727" height="20" width="20">
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --><form data-autosubmit="true" data-remote="true" class="js-social-container" action="https://github.com/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="eIgIh7sGe8EwDkR+md1TxpWAFcyO5lsCbgNkRfMHl23EiGwgHvorg2+a1beNsgLIy12P/Z6qZi2mR+HM/uuhuA==">      <input type="hidden" name="repository_id" id="repository_id" value="140414134" class="form-control">
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --><form class="starred js-social-form" action="https://github.com/ravi4all/ML_JulyRegularEvening/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="S47ky0fV/5bw2l7u2pS4UDbQxXHVs2QpVX+hkqbD0iq9Komt/784zNOHFmfehLROWIT7Z/MykMvb82XbqjIosA==">
    ...
    <!-- '"` --><!-- </textarea></xmp> --><form class="unstarred js-social-form" action="https://github.com/ravi4all/ML_JulyRegularEvening/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="yPlkUwVQeSqZ1JcC5dYnGitwfxbTvKe3ADCRZmDwzaaWOSLqdQ1sZyU2mvMdskY7zFDnxxIC0PGVYDSsoBWsZg==">
      <input type="hidden" name="context" value="repository">
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --><form class="btn-with-count" action="https://github.com/ravi4all/ML_JulyRegularEvening/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="RMaK00/gyDrXg4p7qEm7877aUwQIbsd4K/U4ZIKUXBj5k9JIp8v+uCSdTSZAY9hsbEafIqmXNyZczvAmWLYAYg==">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="https://github.com/ravi4all/ML_JulyRegularEvening/blob/d65c8f1aafaaeb39c2885643706f9db6cdb10a07/FaceDetection/FaceRecog/faceStore.py">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:f5eeb54f513a6a00711d1e8af5e2c903 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax="">
    ...
    <div class="select-menu-modal" id="abId0.6976871072084798">
      <div class="select-menu-header">
        <svg class="octicon octicon-x js-menu-close" role="img" aria-label="Close" viewBox="0 0 12 16" version="1.1" width="12" height="16"><path fill-rule="evenodd" d="M7.48 8l3.75 3.75-1.48 1.48L6 9.48l-3.75 3.75-1.48-1.48L4.52 8 .77 4.25l1.48-1.48L6 6.52l3.75-3.75 1.48 1.48L7.48 8z"></path></svg>
        <span class="select-menu-title">Switch branches/tags</span>
      </div>

      <div class="select-menu-filters" id="abId0.9052464599410439">
        <div class="select-menu-text-filter" id="abId0.3556047222084624" abineguid="28EC4FC76F4B460A87A0D7515FE799C2">
          <input type="text" aria-label="Filter branches/tags" id="context-commitish-filter-field" class="form-control js-filterable-field js-navigation-enable" placeholder="Filter branches/tags">
        </div>
        <div class="select-menu-tabs">
          <ul>
            <li class="select-menu-tab">
              <a href="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py#" data-tab-filter="branches" data-filter-placeholder="Filter branches/tags" class="js-select-menu-tab" role="tab">Branches</a>
            </li>
            <li class="select-menu-tab">
              <a href="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py#" data-tab-filter="tags" data-filter-placeholder="Find a tag…" class="js-select-menu-tab" role="tab">Tags</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected" href="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py" data-name="master" data-skip-pjax="true" rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="https://github.com/ravi4all/ML_JulyRegularEvening/commit/b42ff15ee06f81e8d4267f62996697664ea68692" data-pjax="">
          b42ff15
        </a>
        <relative-time datetime="2018-07-24T11:48:57Z" title="Jul 24, 2018, 4:48 AM PDT">14 days ago</relative-time>
      </span>
      <div>
        <a rel="author" data-skip-pjax="true" data-hovercard-user-id="22050978" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/ravi4all" aria-describedby="hovercard-aria-description"><img class="avatar" src="./facestore_files/22050978" width="20" height="20" alt="@ravi4all"></a>
        <a class="user-mention" rel="author" data-hovercard-user-id="22050978" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/ravi4all" aria-describedby="hovercard-aria-description">ravi4all</a>
          <a data-pjax="true" title="Add files via upload" class="message" href="https://github.com/ravi4all/ML_JulyRegularEvening/commit/b42ff15ee06f81e8d4267f62996697664ea68692">Add files via upload</a>
      </div>
...
<details class="details-reset details-overlay details-overlay-dark lh-default text-gray-dark float-left mr-2" id="blob_contributors_box">
        ...
        <ul class="list-style-none overflow-auto">
            <li class="Box-row">
              <a class="link-gray-dark no-underline" href="https://github.com/ravi4all">
                <img class="avatar mr-2" alt="" src="./facestore_files/22050978" width="20" height="20">
                ravi4all
</a>            </li>
        </ul>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="https://github.com/ravi4all/ML_JulyRegularEvening/raw/master/FaceDetection/FaceRecog/faceStore.py">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="https://github.com/ravi4all/ML_JulyRegularEvening/blame/master/FaceDetection/FaceRecog/faceStore.py">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="https://github.com/ravi4all/ML_JulyRegularEvening/commits/master/FaceDetection/FaceRecog/faceStore.py">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw" href="https://desktop.github.com/" aria-label="Open this file in GitHub Desktop" data-ga-click="Repository, open with desktop, type:windows">
          ...
          <!-- '"` --><!-- </textarea></xmp> --><form class="inline-form js-update-url-with-hash" action="https://github.com/ravi4all/ML_JulyRegularEvening/edit/master/FaceDetection/FaceRecog/faceStore.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="ti8iFtnw86HbkpdT+DTPmJeVOBE6WhxHOJWCNLs3hMi1xFjOLbnZ3wUP9UEYVboz1GPTUrzTrK2z/wCiMQRbbg==">
        ...
        <!-- '"` --><!-- </textarea></xmp> --><form class="inline-form" action="https://github.com/ravi4all/ML_JulyRegularEvening/delete/master/FaceDetection/FaceRecog/faceStore.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="pbR+Vpg+r6hEB8LQj+co6tjhNKu/WChkLFLnxuLvxC3GswmkItUeAdBCu1aZvykHQqurbfbg4PxWlIihUOVEQg==">
  ...
  <div itemprop="text" class="blob-wrapper data type-python">
      ...
      <tr>
        ...
        <td id="LC8" class="blob-code blob-code-inner js-file-line">data <span class="pl-k">=</span> []</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-code blob-code-inner js-file-line"><span class="pl-k">while</span> <span class="pl-c1">True</span>:</td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code blob-code-inner js-file-line">    ret, img <span class="pl-k">=</span> capture.read()</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">if</span> ret:</td>
      </tr>
      <tr>
        <td id="L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="LC13" class="blob-code blob-code-inner js-file-line">        gray <span class="pl-k">=</span> cv2.cvtColor(img, cv2.<span class="pl-c1">COLOR_BGR2GRAY</span>)</td>
      </tr>
      <tr>
        <td id="L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="LC14" class="blob-code blob-code-inner js-file-line">        face <span class="pl-k">=</span> dataset.detectMultiScale(gray, <span class="pl-c1">1.3</span>)</td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">for</span> x, y, w, h <span class="pl-k">in</span> face:</td>
      </tr>
      <tr>
        <td id="L16" class="blob-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-code blob-code-inner js-file-line">            faceComponent <span class="pl-k">=</span> img[y:y<span class="pl-k">+</span>h, x:x<span class="pl-k">+</span>w, :]</td>
      </tr>
      <tr>
        <td id="L17" class="blob-num js-line-number" data-line-number="17"></td>
        <td id="LC17" class="blob-code blob-code-inner js-file-line">            faceComp <span class="pl-k">=</span> cv2.resize(faceComponent, (<span class="pl-c1">50</span>,<span class="pl-c1">50</span>))</td>
      </tr>
      <tr>
        <td id="L18" class="blob-num js-line-number" data-line-number="18"></td>
        <td id="LC18" class="blob-code blob-code-inner js-file-line">            cv2.rectangle(img, (x,y), (x<span class="pl-k">+</span>w, y<span class="pl-k">+</span>h), (<span class="pl-c1">0</span>,<span class="pl-c1">0</span>,<span class="pl-c1">255</span>), <span class="pl-c1">4</span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC20" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">if</span> <span class="pl-c1">len</span>(data) <span class="pl-k">&lt;=</span> <span class="pl-c1">20</span>:</td>
      </tr>
      <tr>
        <td id="L21" class="blob-num js-line-number" data-line-number="21"></td>
        <td id="LC21" class="blob-code blob-code-inner js-file-line">                data.append(faceComp)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC23" class="blob-code blob-code-inner js-file-line">        cv2.imshow(<span class="pl-s"><span class="pl-pds">'</span>result<span class="pl-pds">'</span></span>, img)</td>
      </tr>
      <tr>
        <td id="L24" class="blob-num js-line-number" data-line-number="24"></td>
        <td id="LC24" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">if</span> cv2.waitKey(<span class="pl-c1">1</span>) <span class="pl-k">==</span> <span class="pl-c1">27</span> <span class="pl-k">or</span> <span class="pl-c1">len</span>(data) <span class="pl-k">&gt;=</span> <span class="pl-c1">20</span>:</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC27" class="blob-code blob-code-inner js-file-line">        <span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">"</span>Some Error<span class="pl-pds">"</span></span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC29" class="blob-code blob-code-inner js-file-line">data <span class="pl-k">=</span> np.asarray(data)</td>
      </tr>
      <tr>
        <td id="L30" class="blob-num js-line-number" data-line-number="30"></td>
        <td id="LC30" class="blob-code blob-code-inner js-file-line">np.save(<span class="pl-s"><span class="pl-pds">'</span>face_1.npy<span class="pl-pds">'</span></span>, data)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC32" class="blob-code blob-code-inner js-file-line">cv2.destroyAllWindows()</td>
      </tr>
      <tr>
        <td id="L33" class="blob-num js-line-number" data-line-number="33"></td>
        <td id="LC33" class="blob-code blob-code-inner js-file-line">capture.release()</td>
      </tr>
</tbody></table>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu role="menu">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="https://github.com/ravi4all/ML_JulyRegularEvening/blame/d65c8f1aafaaeb39c2885643706f9db6cdb10a07/FaceDetection/FaceRecog/faceStore.py">View git blame</a></li>
  ...
  <details class="details-reset details-overlay details-overlay-dark">
    ...
    <details-dialog class="Box Box--overlay d-flex flex-column anim-fade-in fast linejump" aria-label="Jump to line" role="dialog">
      <!-- '"` --><!-- </textarea></xmp> --><form class="js-jump-to-line-form Box-body d-flex" action="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py" accept-charset="UTF-8" method="get" abineguid="3B4036D2FFB64A6687EC191C8AECFA8D"><input name="utf8" type="hidden" value="✓">
...
<div class="footer container-lg px-3" role="contentinfo">
  ...
  <div id="ajax-error-message" class="ajax-error-message flash flash-error">
    ...
    <script crossorigin="anonymous" integrity="sha512-ZCuUuaCERG6/AdCPvg2qDAGDVKP7KsHnKx3EuTwcIZSLeqJpyqaZZBUmbK7Wbtgar1y1iAlO66Vstl53f/EFOg==" type="application/javascript" src="./facestore_files/frameworks-b83c5ea8e6d3b8ce4839ec986855c7bf.js.download"></script>
    
    <script crossorigin="anonymous" async="async" integrity="sha512-GnBABJNGG6TZ7dBGZX44eMUQLy14S8kZ2MP1nrD7xRPhwoEfbAZ9LuFucQzOWq9e4Yw5VZzyYTXvzTb8ugcQfA==" type="application/javascript" src="./facestore_files/github-80ee24e5c6973316a33aff113e20c7a2.js.download"></script>
    
    
    
  <div class="js-stale-session-flash stale-session-flash flash flash-warn flash-banner d-none">
    <svg class="octicon octicon-alert" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8.893 1.5c-.183-.31-.52-.5-.887-.5s-.703.19-.886.5L.138 13.499a.98.98 0 0 0 0 1.001c.193.31.53.501.886.501h13.964c.367 0 .704-.19.877-.5a1.03 1.03 0 0 0 .01-1.002L8.893 1.5zm.133 11.497H6.987v-2.003h2.039v2.003zm0-3.004H6.987V5.987h2.039v4.006z"></path></svg>
    <span class="signed-in-tab-flash">You signed in with another tab or window. <a href="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py">Reload</a> to refresh your session.</span>
    <span class="signed-out-tab-flash">You signed out in another tab or window. <a href="https://github.com/ravi4all/ML_JulyRegularEvening/blob/master/FaceDetection/FaceRecog/faceStore.py">Reload</a> to refresh your session.</span>
  </div>
